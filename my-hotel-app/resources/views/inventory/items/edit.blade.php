                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="minimum_stock_level" name="minimum_stock_level" type="number" 
                                    class="mt-1 block w-full" :value="old('minimum_stock_level', $item->minimum_stock_level)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="unit_of_measure" name="unit_of_measure" type="text" 
                                    class="mt-1 block w-full" :value="old('unit_of_measure', $item->unit_of_measure)" required />
