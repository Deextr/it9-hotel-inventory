    ...
    <div class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('inventory.items.create') }}" class="text-blue-600 hover:text-blue-900 flex items-center p-1 rounded-full hover:bg-blue-100" title="Add Item">
                    ...
                    <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:justify-between md:items-end">
                        ...
                        <div class="md:ml-2 w-full md:w-auto">
                            ...
                            <div class="flex">
                                ...
                                <button type="submit" class="text-gray-600 hover:text-gray-900 flex items-center p-1 rounded-full hover:bg-gray-100" title="Search">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="p-6 bg-white border-b border-gray-200">
                @if($items->isEmpty())
                    <div class="flex flex-col items-center justify-center py-12">
                        ...
                        <a href="{{ route('inventory.items.create') }}" class="text-blue-600 hover:text-blue-900 flex items-center p-1 rounded-full hover:bg-blue-100" title="Create your first item">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd" />
                            </svg>
                        </a>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center space-x-3">
                                                <a href="{{ route('inventory.items.edit', $item) }}" class="text-indigo-600 hover:text-indigo-900 flex items-center p-1 rounded-full hover:bg-indigo-100" title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                ...
                                                <form method="POST" action="{{ route('inventory.items.toggle-status', $item) }}" class="inline">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit" class="{{ $item->is_active ? 'text-yellow-600 hover:text-yellow-900' : 'text-green-600 hover:text-green-900' }} flex items-center p-1 rounded-full {{ $item->is_active ? 'hover:bg-yellow-100' : 'hover:bg-green-100' }}" title="{{ $item->is_active ? 'Deactivate' : 'Activate' }}">
                                                        @if ($item->is_active)
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
