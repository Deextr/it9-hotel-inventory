                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('inventory.categories.update', $category) }}" method="POST">
                        ...
                        <div class="mt-6 space-x-3 flex items-center justify-end">
                            <a href="{{ route('inventory.categories.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded-lg transition duration-150 ease-in-out">
                                Cancel
                            </a>
