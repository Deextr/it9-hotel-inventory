    ...
    <div class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('inventory.categories.create') }}" class="text-blue-600 hover:text-blue-900 flex items-center p-1 rounded-full hover:bg-blue-100" title="Add Category">
                                ...
                                @foreach ($categories as $category)
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 flex items-center space-x-3">
                                            <a href="{{ route('inventory.categories.edit', $category) }}" class="text-indigo-600 hover:text-indigo-900 flex items-center p-1 rounded-full hover:bg-indigo-100" title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <form method="POST" action="{{ route('inventory.categories.toggle-status', $category) }}" class="inline">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit" class="{{ $category->is_active ? 'text-yellow-600 hover:text-yellow-900' : 'text-green-600 hover:text-green-900' }} flex items-center p-1 rounded-full {{ $category->is_active ? 'hover:bg-yellow-100' : 'hover:bg-green-100' }}" title="{{ $category->is_active ? 'Deactivate' : 'Activate' }}">
                                                    @if ($category->is_active)
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
