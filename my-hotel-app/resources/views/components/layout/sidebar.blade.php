<aside class="bg-gray-800 text-white w-64 min-h-screen px-4 py-6 fixed left-0">
    ...
    <nav class="space-y-2">
        ...
        <!-- Suppliers -->
        <a href="{{ route('inventory.suppliers.index') }}" class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('inventory.suppliers.*') ? 'bg-gray-900' : 'hover:bg-gray-700' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Purchase Orders -->
        <a href="{{ route('inventory.purchase_orders.index') }}" class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('inventory.purchase_orders.*') ? 'bg-gray-900' : 'hover:bg-gray-700' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
